const brettData:BrettData = {
  0: { 
    startePeng: 7, melding:'Lag ein kanal mellom dei røde punkta.',kant:[0,'kant'],
  ...
  1: { startePeng: 9, melding:'Nytt: Fjell kan ikkje gravast til kanal.',kant:[0,'kant'],
      X0Y0: [0,'start'],X1Y0: [0,'vatn'], X2Y0: [0,'land'], X3Y0:  [0,'land'], X4Y0: [0,'land'], X5Y0: [0,'land'], X6Y0: [0,'land'], X7Y0: [0,'vatn'],
  ...
  2: { startePeng: 15, melding:'Nytt: Sluser kan koble høg og låg kanal.',kant:[0,'kant'],
  ...
  3: { startePeng: 15, melding:'Nytt: Sluser kan koble høg og låg kanal.',kant:[0,'kant'],
